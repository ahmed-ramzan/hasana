                    ...
                    <div class="card card-success">
                        ...
                        <form method="post" action="{{route('communities.store')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="email">Community Email</label>
                                    <input type="email" class="form-control"
                                           name="email"
                                           value="{{old('email')}}"
                                           placeholder="Enter Community Email" required>
                                    <p class="text-danger">@error('email'){{$message}}@enderror</p>
                                </div>

                                <div class="form-group">
                                    <label for="password">Community Password</label>
                                    <input type="password" class="form-control"
                                           name="password"
                                           placeholder="Enter Community Password" required>
