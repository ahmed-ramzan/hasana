    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{route('communities.create')}}" class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Add Community</a>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @forelse($communities as $community)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-primary btn-flat btn-sm" href="{{route('communities.edit',$community->id)}}">Edit <i class="fa fa-edit fa-lg"></i></a>
