                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{old('per_person_fund')}}"
                                           placeholder="Enter per person fund" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control"
                                           ...
                                           value="{{old('image')}}"
                                            required>
                                    <small>pic size must be less than 2mb</small>
                               ...
                               {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="city">Select Campaign City</label>
                                ...
                                <div class="form-group">
                                    <label for="city">Select Campaign District</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="description">
                                        Place <em>some</em> <u>Details</u> <strong>here</strong>
                                    </textarea>
