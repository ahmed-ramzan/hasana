                    ...
                    <div class="card card-success">
                        ...
                        <!-- form start -->
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="title">Campaign city</label>
                                    <input type="text" class="form-control"
                                           name="title"
                                           value="{{$campaign->city}}"
                                           disabled>
                                ...
                                <div class="form-group">
                                    <label for="title">Campaign District</label>
                                    <input type="text" class="form-control"
                                           name="title"
                                ...
                                <div class="form-group">
                                    <label for="title">Per person fund</label>
                                    <input type="text" class="form-control"
                                           name="title"
                                ...
                                <div class="form-group">
                                    ...
                                    <p><img class="w-50" src="/storage/{{$campaign->image}}" alt="image"></p>
                                </div>
                            ...
                            <div class="card-footer">
                                <a href="{{route('campaigns.index')}}" class="btn btn-success">Back To Campaigns</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
