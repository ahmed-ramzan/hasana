        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open">
                    <a href="{{(Auth::user()->role_id===1 ? '/admin' : '/community')}}" class="nav-link active">
                ...
                @if(Auth::user()->role_id === 1)
                    ...
                    <li class="nav-item">
                        <a href="{{route('camp.index')}}" class="nav-link">
                            <i class="nav-icon far fa-image"></i>
                            <p>
                                Campaigns
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{route('camps.rank')}}" class="nav-link">
                    ...
                    {{--<li class="nav-item">
                        <a type="button" data-toggle="modal" data-target="#admin-modal" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{route('community-profile.create')}}" class="nav-link">
                        <i class="nav-icon far fa-calendar-alt"></i>
                        <p>
                            Edit profile
                        </p>
