...
@section('content')
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay=".6s">{{__('translation.title')}}<br> {{__('translation.lowtitle')}}</h1>
                                    <P data-animation="fadeInUp" data-delay=".8s">{{__('translation.subtitle')}}</P>

                                    <div class="hero__btn">
                                        <a href="{{route('latest-causes')}}" class="btn hero-btn mb-10" data-animation="fadeInLeft" data-delay=".8s">{{__('translation.donate')}}</a>
                                        <a href="{{route('latest-causes')}}" class="cal-btn ml-15" data-animation="fadeInRight" data-delay="1.0s">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <span>{{__('translation.Our-Cases-you-can-see')}}</span>
                            <h2>{{__('translation.Explore-our-latest-causes-that-we-works')}}</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-10">
                        ...
                        <a href="{{route('about')}}" class="btn">{{__('translation.about')}}</a>
                    </div>
        ...
        {{--<section class="featured-job-area section-padding30 section-bg2" data-background="img/gallery/section_bg03.png">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 col-md-10 col-sm-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <span>{{__('translation.what-we-are-doing')}}</span>
                            <h2>{{__('translation.We-arrange-many-social-events-for-charity-donations')}}</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    <a href="#"><h4>{{__('translation.Donation-is-Hope')}}</h4></a>
                                    <ul>
                                        <li><i class="far fa-clock"></i>8:30 - 9:30am</li>
                                        <li><i class="fas fa-sort-amount-down"></i>18.01.2021</li>
                                        <li><i class="fas fa-map-marker-alt"></i>{{__('translation.country')}}, {{__('translation.city')}}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    <a href="#"><h4>{{__('translation.A-hand-for-Children')}}</h4></a>
                                    <ul>
                                        <li><i class="far fa-clock"></i>8:30 - 9:30am</li>
                                        <li><i class="fas fa-sort-amount-down"></i>18.01.2021</li>
                                        <li><i class="fas fa-map-marker-alt"></i>{{__('translation.country')}}, {{__('translation.city')}}</li>
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    <a href="#"><h4>{{__('translation.Help-for-Children')}}</h4></a>
                                    <ul>
                                        <li><i class="far fa-clock"></i>8:30 - 9:30am</li>
                                        <li><i class="fas fa-sort-amount-down"></i>18.01.2021</li>
                                        <li><i class="fas fa-map-marker-alt"></i>{{__('translation.country')}}, {{__('translation.city')}}</li>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                        ...
                        <div class="section-tittle section-tittle2 text-center mb-70">
                            <span>{{__('translation.what-we-are-doing')}}</span>
                            <h2>{{__('translation.Our-Expert-Volunteer-Alwyes-ready')}}</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <h3><a href="#">{{__('translation.person-name')}}</a></h3>
                                <p>{{__('translation.Volunteer-leader')}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="img/gallery/dashboard-blog1.png" alt="">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="img/gallery/dashboard-blog2.png" alt="">
